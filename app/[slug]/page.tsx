          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 sm:gap-2.5 flex-shrink-0 relative z-10 w-full sm:w-auto">
            ...
            {business.telefono_whatsapp && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-3 py-2 rounded-2xl text-xs font-display font-bold bg-brand-500/10 hover:bg-brand-500/20 border border-brand-500/30 text-brand-400 hover:text-brand-300 transition-all flex items-center justify-center gap-1.5 shadow-md active:scale-95"
                title="Contactar al local por WhatsApp"
              >
                <PhoneCall className="w-3.5 h-3.5 text-brand-400 flex-shrink-0" />
                <span>WhatsApp</span>
              </a>
            )}
          </div>
