...
export function CustomerOrdersDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden font-sans">
      <div
        className="absolute inset-0 bg-[#05070D]/80 transition-opacity animate-fade-in"
        onClick={onClose}
      />
        ...
        <div className="w-screen max-w-md bg-[#0B0F1B] border-l border-white/10 flex flex-col justify-between shadow-2xl relative z-10 text-slate-100">
          ...
          <div className="p-5 border-b border-white/10 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-display font-black text-lg text-white leading-tight">Mis Pedidos en Kaltiro</h2>
