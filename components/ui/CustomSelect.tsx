...
interface CustomSelectProps {
  ...
  placeholder?: string;
  className?: string;
  accentColor?: 'brand' | 'purple' | 'amber' | 'sky';
  size?: 'normal' | 'compact';
}
...
export function CustomSelect({
  ...
  const borderGlowMap = {
    ...
    brand: 'focus:border-brand-500 border-slate-800 hover:border-brand-500/40',
  ...
  const activeOptionMap = {
    ...
    brand: 'bg-brand-500/15 text-brand-300 font-bold',
